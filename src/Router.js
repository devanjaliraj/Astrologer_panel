...
// status //
const StatusList = lazy(() => import("./views/apps/status/StatusList"));
      ...
      <Router history={history}>
        <HashRouter>
          <Switch>
            ...
            />
            {/* status */}
            <AppRoute path="/app/status/statusList" component={StatusList} />
            {/* Customer */}
            <AppRoute
            ...
            />
            <AppRoute
              path="/app/customer/addCustomer"
              component={AddCustomer}
            />
            <AppRoute
              path="/app/customer/editCustomer"
              component={EditCustomer}
            />
            <AppRoute
              path="/app/customer/viewCustomer"
